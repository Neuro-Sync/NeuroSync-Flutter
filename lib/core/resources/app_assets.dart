...
class AppAssets {
  ...
  static const String pdf_IC = "${basePathImages}pdf.png";
  static const String files_IC = "${basePathImages}files.png";
  static const String raw_images_IC = "${basePathImages}raw_images.png";
  static const String raw_video_IC = "${basePathImages}raw_video.png";
  static const String record_IC = "${basePathImages}record.png";
