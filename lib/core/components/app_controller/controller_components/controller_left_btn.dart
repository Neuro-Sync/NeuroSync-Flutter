...
class ControllerLeftbtn extends StatefulWidget {
  ...
  @override
  State<ControllerLeftbtn> createState() => _ControllerLeftbtnState();
}

class _ControllerLeftbtnState extends State<ControllerLeftbtn> {
  @override
        ...
        return ChildBuildBlock(
          ...
          childContent: Container(
            ...
            decoration: BoxDecoration(
                ...
                color: appCubit.stepsCountIncontrller == 3 &&
