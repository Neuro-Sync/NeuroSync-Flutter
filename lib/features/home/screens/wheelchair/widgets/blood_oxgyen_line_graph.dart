...
class BloodOxgyenItem extends StatefulWidget {
  const BloodOxgyenItem({super.key});

  @override
  State<StatefulWidget> createState() => BloodOxgyenItemState();
}

class BloodOxgyenItemState extends State<BloodOxgyenItem> {
      ...
      child: Column(
        ...
        children: <Widget>[
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5.82.r),
                      color: AppColors.bloodoxygengreencolor),
                  child: Padding(
                    padding: EdgeInsets.all(4.0.sp),
                    child: SvgPicture.asset(
                      AppAssets.bood_oxygen_ic,
                      width: 14.54.w,
                      height: 13.41.h,
                    ),
                  ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                AppText("102", fontSize: 16.sp, color: AppColors.blackColor),
                Gap(4.w),
                AppText("/72",
